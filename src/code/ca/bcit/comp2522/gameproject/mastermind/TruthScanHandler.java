...
public final class TruthScanHandler
{
     ...
     * @return true if the scan was performed, false otherwise
     */
    public boolean handleTruthScanRequest(final List<Round> rounds, 
     ...
     */
    public boolean isTruthScanUsed()
    {
